        ...
        <>
            <div style={{backgroundColor: "white", border: "yellow solid 2px", marginLeft:"auto", marginRight:"auto", width: "100%"}}>
                <div className="resumeStyle">
                    ...
                    <Link style={{fontSize:"20px", textDecoration: "none"}} class="current" to="/resume_code">Resume(full stack developer)</Link> 
                    <Link class="currentOff" style={{fontSize:"20px", textDecoration: "none"}} to="/resume_anim">Resume(cg animator)</Link>
